...
To deploy and run the application on the Samsung smart TV, you would first need to connect your TV to Visual Studio.
...
When you open the "Apps" panel after the reboot, "Develop Mode" is marked at the top of the screen.<br>
...
## Connect TV to the Visual Studio
  1. In the Visual Studio, select "Tools > Tizen > Tizen Device Manager".<br>
     For Mac user, launch `device-manager` on Mac.
  ...
  3. In the "Add Device" popup, define the information for the TV you want to connect to, such as the name, IP address, and port number, and click "Add". Normally, you just need to put IP address.<br>
...
When the TV is successfully connected, you can see the connected TV on the Visual Studio toolbar.<br>
